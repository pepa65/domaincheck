...
**The repo <https://github.com/saidutt46/domain-check> this is based on has developed so much that this strong recommendation to use that project instead of this one is issued here!**
...
🔴 example.com TAKEN  1995-08-14T04:00:00Z..20.5.48-13T04:00:00Z @"RESERVED-Internet Assigned Numbers Authority" client delete prohibited, client transfer prohibited, client update prohibited
...
[
  {
    ...
    "info": {
      ...
      "expiration_date": "20.5.48-13T04:00:00Z",
      "status": [
